...
export const generatePhoneNumbers = async (country: any) => {
  try {
    const response = await axios.post(
      "http://192.168.100.100:8080/api/phone/generate",
      { country: country }
    );
...
export const checkwhatsAppNumber = async (numbers: any) => {
  try {
    const response = await axios.post(
      "http://192.168.100.100:8080/api/phone/save",
      {
        users: numbers,
      }
    );
...
export const sendwhatsAppMessage = async (message: any, phoneNumbers: any) => {
  try {
    const response = await axios.post(
      "http://192.168.100.100:8080/api/phone/message",
...
export const uploadFile = async (file) => {
  try {
    ...
    const response = await axios.post(
      "http://192.168.100.100:8080/api/phone/upload",
      formData,
      {
        headers: {
...
export const downloadFile = async (data) => {
  try {
    const response = await axios.post(
      "http://192.168.100.100:8080/api/phone/download",
      {
        phoneNumbers: data,
      },
      {
